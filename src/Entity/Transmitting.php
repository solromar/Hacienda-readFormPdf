...
use App\Repository\TransmittingRepository;
use Doctrine\ORM\Mapping as ORM;
use Dracoder\EntityBundle\Model\AbstractTimetrackeableEntity;

/**
 * @ORM\Entity(repositoryClass=TransmittingRepository::class)
 */
class Transmitting extends AbstractTimetrackeableEntity
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Model600::class, inversedBy="transmittings")
     */
    private $Model600transmittings;
    ...
    public function getModel600transmittings(): ?Model600
    {
        return $this->Model600transmittings;
    }

    public function setModel600transmittings(?Model600 $Model600transmittings): self
    {
        $this->Model600transmittings = $Model600transmittings;
